...
## Compatibility
- **ComfyUI 0.9.2+**: Fully supported
- **ComfyUI 0.8.x - 0.9.1**: Partially supported (backward compatible)
- This extension is designed to work with multiple ComfyUI versions and includes automatic compatibility handling
